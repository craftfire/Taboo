...
public class TabooException extends Exception {
    private static final long serialVersionUID = -2501215894712048102L;

    public TabooException() {
    }
    ...
    public TabooException(Throwable cause) {
        super(cause);
    }
